...
TRACKING_MAP_PATH="./val_resources/oakink2_val/val_tracking.mp4"
DEPTH_MAP_PATH="./val_resources/oakink2_val/val_depth.mp4"
NORMAL_MAP_PATH="./val_resources/oakink2_val/val_normal.mp4"
SEG_MASK_PATH="./val_resources/oakink2_val/val_seg_mask.mp4"
HAND_KEYPOINTS_PATH="./val_resources/oakink2_val/val_hand.mp4"
VALIDATION_PROMPT="One or two hands are moving."
VALIDATION_IMAGES="./val_resources/oakink2_val/val_image.png"
  ...
  for lr_schedule in "${LR_SCHEDULES[@]}"; do
    for optimizer in "${OPTIMIZERS[@]}"; do
      for steps in "${MAX_TRAIN_STEPS[@]}"; do
        output_dir="./exps/Oakink2/main_all_cond_HOI_s0_split_${steps}__optimizer_${optimizer}__lr-schedule_${lr_schedule}__learning-rate_${learning_rate}/"
