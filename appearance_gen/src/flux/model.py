...
class SimControl(nn.Module):
    def __init__(self, controlnet, hamer_model_list, dsine_model):
        super().__init__()
        self.controlnet = controlnet
        self.hamer_model, self.hamer_model_cfg, self.hamer_detector, self.hamer_cpm = \
            hamer_model_list
        self.dsine_model = dsine_model
