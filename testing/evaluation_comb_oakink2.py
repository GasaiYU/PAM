...
from training.dataset import VideoDataset, VideoDatasetWithResizingTracking, HOIVideoDatasetResizing, Oakink2VideoDatasetResizing
...
def sample_from_dataset(
    ...
    """Sample from dataset"""
    dataset = Oakink2VideoDatasetResizing(
        data_root=data_root,
        caption_column=caption_column,
        tracking_column=tracking_column,
        normal_column=normal_column,
        depth_column=depth_column,
        hand_keypoints_column=hand_column,
...
def generate_video(
    ...
    if all([data_root, caption_column, tracking_column, video_column, normal_column, depth_column, hand_column, seg_mask_column]):
...
if __name__ == "__main__":
    ...
    parser.add_argument("--hand_column", type=str, required=True, help="Name of the tracking column")
    parser.add_argument("--seg_mask_column", type=str, required=True, help="Name of the tracking column")
