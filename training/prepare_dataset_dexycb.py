...
from dataset import BucketSampler, VideoDatasetWithResizing, VideoDatasetWithResizeAndRectangleCrop, HOIVideoDatasetResizing  # isort:skip
...
def main():
    ...
    if args.video_reshape_mode is None:
        dataset = HOIVideoDatasetResizing(**dataset_init_kwargs)
    else:
